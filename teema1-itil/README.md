...
Oluline on eristada kiireid probleeme ja nende tegelikke põhjuseid.  
Muudatusi tuleb planeerida, et vältida uusi vigu.  
ITIL ei ole range reegel, vaid paindlik juhend.

## Näide
Kui kooli printer ei tööta, on see **incident**.  
Kui printer iga nädal sama vea tõttu kinni jookseb, on see **problem**.
